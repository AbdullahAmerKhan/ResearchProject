...
public class JsonDumpProcessor implements EntityDocumentProcessor {
	...
	public void processItemDocument(ItemDocument itemDocument) {
		...
		for (StatementGroup statementGroup : itemDocument.getStatementGroups()) {
			...
			String sum_val=statementGroup.getProperty().getId();
			logger.info(sum_val);
	...
	private void extractDescriptions(ItemDocument itemDocument) {
		...
		String query = "INSERT INTO wikischema.descriptions (entity_id, term_language, term_text)"
				+ " VALUES(?, ?, ?)";
	...
	private void addTermToDatabase(String itemId, String termType, String languageCode, String text) {
		String query = "INSERT INTO wikischema.terms (entity_id, term_type, term_language, term_text)"
				+ " VALUES(?, ?, ?, ?)";
	...
	private void extractSnaks(ItemDocument itemDocument) {
		ArrayList<String> snaks = new ArrayList<String>();
	...
	private void insertCoordinates(ItemDocument itemDocument, GlobeCoordinatesValue value) {
		String query = "INSERT INTO wikischema.coordinates (entity_id, globe, precision, latitude, longitude)"
				+ " VALUES(?, ?, ?, ?, ?)";
	...
	private void insertValueSnaks(ItemDocument itemDocument, ArrayList<String> snaks) {
		String query = "INSERT INTO wikischema.value_snaks (entity_id, values) VALUES(?,?)";
